...
%The practical demonstration (refer to Section \ref{sec:practical}) illustrates the tasks (a), (b) and (c), and makes use of data from the public transportation system of Porto (Portugal) and two prototypical visualization techniques. The discussion about the advantages of a particular type of recommendation algorithm is outside the scope of this article.
...
\begin{tabular}{c|l|p{14cm}}
    ...
    \multirow{5}{*}{\textit{\shortstack{Data\\Concept\\(DC)}}}    &   \textit{SpatialReferenceType}	&	- A type of spatial reference.\\
    ...
    \multirow{11}{*}{\textit{\shortstack{Domain\\User\\Concept\\(DUC)}}}		&	\textit{DomainUser}	& - A user of a VUMO-based visualization system. \\
...
\begin{figure}
\centering
\subfloat[Geographic heat map\label{subfig:geoheatmap_spec}]{\includegraphics[width=0.8\linewidth]{images/geoheatmap_spec}}
\\
\subfloat[Calendar heat map\label{subfig:calheatmap_spec}]{\includegraphics[width=0.8\linewidth]{images/calheatmap_spec}}
...
\begin{figure}
\centering
\subfloat[Geographic heat map\label{subfig:geoheatmap}]{\includegraphics[width=0.8\linewidth]{images/geoheatmap}}
\\
\subfloat[Calendar heat map\label{subfig:calheatmap}]{\includegraphics[width=0.8\linewidth]{images/calheatmap}}
